        ...
        <>
            ...
            <div className="flex flex-wrap justify-between items-center gap-4">
                <div className="flex min-w-72 flex-col gap-1">
                    <p className="text-2xl lg:text-3xl font-bold leading-tight tracking-tight">Settings</p>
            ...
            <div className="flex flex-col items-center justify-center h-96 bg-white dark:bg-[#1a1d21] border border-[#e5e7eb] dark:border-[#282f39] rounded-xl text-center p-8">
                ...
                <h3 className="text-xl font-bold mb-2">Settings Module</h3>
                <p className="text-gray-500 max-w-md">
                    This feature is currently under development. Please check back later for updates on settings functionality.
                </p>
            </div>
        </>
    );
