        ...
        <>
            ...
            <div className="flex flex-wrap justify-between items-center gap-4">
                <div className="flex min-w-72 flex-col gap-1">
                    <p className="text-2xl lg:text-3xl font-bold leading-tight tracking-tight">Vulnerabilities</p>
            ...
            <div className="flex flex-col items-center justify-center h-96 bg-[#0A0F16] border border-white/10 rounded-xl text-center p-8">
                ...
                <h3 className="text-xl font-bold mb-2 text-white">Vulnerabilities</h3>
