...
from .views import (
    ...
    verify_tenant_invite_token_view, verify_invite_token_get, admin_delete_tenant, admin_update_tenant, admin_block_tenant, admin_restore_tenant,
...
auth_urlpatterns = [
    ...
    path('verify-tenant-invite/', verify_tenant_invite_token_view, name='verify_tenant_invite'),
